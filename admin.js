(()=>{
  ...
  function pageType(){const p=location.pathname.toLowerCase();if(p.includes('/games/snake.html'))return'snake';if(p.includes('/games/'))return'game';return'hub'}
